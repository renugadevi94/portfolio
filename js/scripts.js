function getStackImages(stack) {
    ...
    let baseimgaddr = "/image/"

    for (let tech of stack) {
        let li = document.createElement('li');
        li.className = "list-group-item"
        if (tech == "javascript.png" || "css.png" || "html5") {
            li.innerHTML = `<img src='.${baseimgaddr+tech}.png' class="img-fluid" width="30" height="30" />`
        } else {
            li.innerHTML = `<img src='.${baseimgaddr+tech}.jpeg' width="30" height="30" class="img-fluid" />`
        }
        ul.appendChild(li);
    }
    return ul;
